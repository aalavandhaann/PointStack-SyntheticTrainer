...
#SBATCH --time=03-00:30:00     # DD-HH:MM:SS
...
tensorboard --logdir=$SOURCEDIR/experiments/SyntheticPartNormal/synthetic_shapenet/tensorboard/ --host 0.0.0.0 --load_fast false & python $SOURCEDIR/train.py --cfg_file cfgs/syntheticpartnormal/syntheticpartnormal.yaml --exp_name synthetic_shapenet --val_steps=1
